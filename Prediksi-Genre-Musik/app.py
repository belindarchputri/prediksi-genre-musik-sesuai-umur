...
# =========================================================
# LOKASI DASAR APLIKASI
# =========================================================
# Dihitung dari lokasi file app.py ini sendiri, supaya semua
# path file (model, folder musik, dll) tetap benar di mana pun
# aplikasi dijalankan (lokal maupun saat di-deploy).
...
# =========================================================
try:
    model = joblib.load(os.path.join(BASE_DIR, "knn_music_genre_model.pkl"))
    scaler = joblib.load(os.path.join(BASE_DIR, "scaler_age.pkl"))
    genre_encoder = joblib.load(os.path.join(BASE_DIR, "label_encoder_genre.pkl"))
